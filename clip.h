...
public:
    AbstractClip(int referenceId, int mapPosition, int clipPosition,
                 ...
                 const std::vector<BamTools::CigarOp>& cigar, int endPosition);
    ...
    Deletion call(BamTools::BamReader& reader, FaidxWrapper &faidx, int insLength, int minOverlap,
...
protected:
    ...
    virtual Deletion call(FaidxWrapper &faidx, const std::vector<TargetRegion>& regions, int minOverlap,
		double minIdentity, IRealignmentCaller *pRealnCaller) = 0;
...
public:
    ForwardBClip(int referenceId, int mapPosition, int clipPosition, int matePosition,
        const std::string& sequence, const std::vector<BamTools::CigarOp>& cigar, int endPosition);
...
protected:
    Deletion call(FaidxWrapper &faidx, const std::vector<TargetRegion> &regions, int minOverlap,
		double minIdentity, IRealignmentCaller *pRealnCaller);
